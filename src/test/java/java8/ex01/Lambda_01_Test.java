...
public class Lambda_01_Test {
    ...
    public static PersonPredicate p;
    // end::filter[]
    ...
    public void test_filter_by_age() throws Exception {
        ...
        List<Person> result = filter(personList, p = (Person p) -> p.getAge() >= 18);
    ...
    public void test_filter_by_firstname() throws Exception {
        ...
        List<Person> result = filter(personList, p = (Person p) -> p.getFirstname().equals("first_10"));
    ...
    public void test_filter_by_password() throws Exception {
        ...
        List<Person> result = filter(personList, p = (Person p) -> p.getAge() > 49 && DigestUtils.sha512Hex(p.getPassword()).equals(passwordSha512Hex));
